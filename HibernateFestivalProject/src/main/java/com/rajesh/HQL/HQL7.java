...
//           }
        ...
        Query<Object[]> q = s.createQuery(
        	    "SELECT f.description, f.sweet, CONCAT(f.description,' ->',f.sweet) FROM Festival f",
        	    Object[].class
        	);
        	...
        	for (Object[] d : data) {
        	  //  System.out.println("Description: " + d[0]);
        	    //System.out.println("Sweet: " + d[1]);
        	    System.out.println("Combined: " + d[2]);
        	}
